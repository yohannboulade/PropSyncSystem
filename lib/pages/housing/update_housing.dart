...
class UpdateHousingPage extends StatefulWidget {
  final Housing logement;
  final Member member;
  const UpdateHousingPage({super.key, required this.member, required this.logement});
  @override
  UpdateState createState() => UpdateState();
}

class UpdateState extends State<UpdateHousingPage> {
  int _currentPage = 0;
